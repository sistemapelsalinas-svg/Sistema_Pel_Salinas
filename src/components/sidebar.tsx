...
export function Sidebar() {
  ...
  return (
    <>
      <aside className="hidden lg:flex w-64 flex-col flex-shrink-0 border-r border-gray-200/90 dark:border-[#222938] bg-white dark:bg-[#151A23] sticky top-0 h-screen z-30 select-none">
        
        {/* Header */}
        <div className="p-4 border-b border-gray-100 dark:border-[#222938] flex items-center gap-2.5">
                  ...
                  if (item.onClick) {
                    return (
                      <button
                        ...
                        className="w-full flex items-center justify-between px-2.5 py-2 rounded-xl text-xs font-medium text-gray-600 dark:text-gray-400 hover:bg-gray-100/70 dark:hover:bg-[#1D2432] hover:text-gray-900 dark:hover:text-white transition-all text-left"
                      >
